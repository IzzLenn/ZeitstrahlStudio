...
ComboBox-Popups und ihre Einträge verwenden ein eigenes gemeinsames ControlTemplate mit ausschließlich semantischen dynamischen Ressourcen. Kalender-, Kontextmenü-, Tabellen- und Registerflächen erhalten ebenfalls globale themefähige Stile. Die Abhängigkeit von WPF-Systemfarben wurde verworfen, weil sie bei dunkler Anwendung weiterhin weiße Popupflächen erzeugen kann. Bild-, PDF- und Druckvorschauen behalten ihre bereits dokumentierten fachlich neutralen Flächen.
